...
/**
 * A class extending JSSMS.Z80 to handle most of the aspects of dynamic recompilation.
 *
 * @constructor
 * @extends {JSSMS.Z80}
 */
...
JSSMS.Z80DynaRec.prototype = {
  /**
   * This method is used to initialize properties from JSSMS.Z80DynaRec that can't be done at
   * the time the class in instantiated.
   * This method is called only at instantiation, while reset() is called whenever a new rom is
   * loaded.
   */
  init: function() {
  ...
  /**
   * Extract a string from a JavaScript function.
   *
